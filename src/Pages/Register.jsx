      ...
      <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-control">
          ...
          {...register("confrimPassword",
           ...
           {errors.confrimPassword && <span className='text-red-500 text-sm font-light'>Both Passwords must have a match</span>}
        </div>
        <div className="form-control mt-6">
          <button type='submit' className="btn btn-primary">Register</button>
        </div>
          <GoogleLogin/>
      <p className='my-2 font-light text-sm'>Already have an account? <Link to ='/login' className='text-primary font-medium'>Login</Link></p>
      </form>
    </div>
  </div>
</div>
